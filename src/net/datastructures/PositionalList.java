...
public interface PositionalList<E> extends Iterable<E> {
  ...
  /**
   * Returns current index of the element stored at Position p.
   * @return current index of element stored at Position p.
   */
  public default int indexOf(Position<E> p) {
    int indexCounter = 0;
	for (Position<E> position : positions()) {
		System.out.println("PositionalList.indexOf(Position<E> p) --> position.getElement() --> " + position.getElement());
		if (p.getElement().equals(position.getElement())) {
			return indexCounter;
		} 
		indexCounter++;
     }
 ...
 /**
   * Returns current index of the element stored at Element E p.
   * @return current index of element stored at Element E p.
   */
  public default int indexOf(E p) {
	int indexCounter = 0;
	//System.out.println("    indexOf --> p --> " + p);
	for (Position<E> position : positions()) {
		System.out.println("PositionalList.indexOf(E p)  --> position.getElement() --> " + position.getElement());
		if (p.equals(position.getElement())) {
			return indexCounter;
		} 
		indexCounter++;
	}
